...
public class Task3NumCalculation {
    public static void main(String[] args) {
        ...
        if (number > 0) {
            System.out.println("Если оно является положительным, то прибавить к нему 1:  " );
            number = number + 1;

        } else if (number < 0) {
            System.out.println("Если отрицательным, то вычесть из него 2:  " );
            number = number - 2;

            } else {
            System.out.println("Если нулевым, то заменить его на 10:  " );
            number = 10;
             }
